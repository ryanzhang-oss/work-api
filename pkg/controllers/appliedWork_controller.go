...
func (r *AppliedWorkReconciler) collectDisappearedWorks(
	ctx context.Context, appliedWork *workapi.AppliedWork) ([]workapi.AppliedManifestResourceMeta, error) {
	var errs []error
	var disappearedWorks, newRes []workapi.AppliedManifestResourceMeta
